        ...
        <div className="flex flex-row gap-20">
          ...
          <div className="py-[50px] px-[20px]">
            ...
            <div className="flex flex-col gap-[21px]">
              ...
              <p>
                W pracy trenera{" "}
                <strong>stawiam na indywidualne podejście</strong> do każdego
                podopiecznego. Dopasowuję treningi do ich potrzeb i możliwości.{" "}
                <strong>
              ...
              <p>
                ...
                trenerką, zaangażowałam się w to całkowicie. Na kursie
                trenerskim{" "}
                <strong>byłam jedną z tych największych prymusek</strong> –
                zawsze przygotowana i pełna zapału do nauki.
              </p>
              <p>
                Poza treningami{" "}
                <strong>uwielbiam przygotowywać makarony</strong> i spędzać czas
                na rowerze. Moje podejście łączy wiedzę, praktykę i pasję,{" "}
                <strong>
                  dzięki czemu mogę skutecznie wspierać swoich podopiecznych w
                  ich drodze do celu.
                </strong>
              </p>
